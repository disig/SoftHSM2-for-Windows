...
## Build OpenSSL 1.1.0f static library

Download [OpenSSL 1.1.0f](http://openssl.org/source/openssl-1.1.0f.tar.gz) with [its signature](http://openssl.org/source/openssl-1.1.0f.tar.gz.asc) into `C:\build\src\` directory and verify signature of the downloaded archive:

    cd C:\build\src\
    gpg --keyserver pgp.mit.edu --recv-keys 0E604491
    gpg --verify openssl-1.1.0f.tar.gz.asc openssl-1.1.0f.tar.gz

### 32-bit

Extract archive `openssl-1.1.0f.tar.gz` into `C:\build\src\openssl-1.1.0f-x86` directory:

    cd C:\build\src\
    "C:\Program Files\7-Zip\7z" x openssl-1.1.0f.tar.gz
    "C:\Program Files\7-Zip\7z" x openssl-1.1.0f.tar
    rename openssl-1.1.0f openssl-1.1.0f-x86
    del openssl-1.1.0f.tar

In a **new command line window** build OpenSSL and install it into `C:\build\bin\openssl-1.1.0f-x86` directory:

    cd C:\build\src\openssl-1.1.0f-x86
    set PATH=%PATH%;C:\nasm
    "C:\Program Files (x86)\Microsoft Visual Studio 14.0\VC\vcvarsall.bat"
    perl Configure VC-WIN32 --prefix=C:\build\bin\openssl-1.1.0f-x86 --openssldir=C:\build\bin\openssl-1.1.0f-x86\ssl no-shared
    nmake
    nmake test
    nmake install
...
Extract archive `openssl-1.1.0f.tar.gz` into `C:\build\src\openssl-1.1.0f-x64` directory:
    ...
    "C:\Program Files\7-Zip\7z" x openssl-1.1.0f.tar.gz
    "C:\Program Files\7-Zip\7z" x openssl-1.1.0f.tar
    rename openssl-1.1.0f openssl-1.1.0f-x64
    del openssl-1.1.0f.tar

In a **new command line window** build OpenSSL and install it into `C:\build\bin\openssl-1.1.0f-x64` directory:
...
Download [SoftHSM 2.3.0](https://dist.opendnssec.org/source/softhsm-2.3.0.tar.gz) with [its signature](https://dist.opendnssec.org/source/softhsm-2.3.0.tar.gz.sig) into `C:\build\src\` directory and verify signature of the downloaded archive:

    cd C:\build\src\
    gpg --keyserver pgp.mit.edu --recv-keys 4FCB0B94
    gpg --verify softhsm-2.3.0.tar.gz.sig softhsm-2.3.0.tar.gz

### 32-bit

Extract archive `softhsm-2.3.0.tar.gz` into `C:\build\src\softhsm-2.3.0-x86` directory:

    cd C:\build\src\
    "C:\Program Files\7-Zip\7z" x softhsm-2.3.0.tar.gz
    "C:\Program Files\7-Zip\7z" x softhsm-2.3.0.tar
    rename softhsm-2.3.0 softhsm-2.3.0-x86
    del softhsm-2.3.0.tar

Configure build process in a **new command line window**:

    cd C:\build\src\softhsm-2.3.0-x86\win32\
    "C:\Program Files (x86)\Microsoft Visual Studio 14.0\VC\vcvarsall.bat"
    python Configure.py disable-debug disable-gost with-crypto-backend=openssl with-openssl=C:\build\bin\openssl-1.1.0f-x86\ with-cppunit=C:\build\bin\cppunit-1.13.2-x86\

Open solution `C:\build\src\softhsm-2.3.0-x86\win32\softhsm2.sln` in Visual Studio and rebuild the source with `Release\Win32` solution configuration.

Verify the build by running the test programs:

    cd C:\build\src\softhsm-2.3.0-x86\win32\Release\
    cryptotest.exe
    datamgrtest.exe
    handlemgrtest.exe
    objstoretest.exe
...
Copy the results into `C:\build\bin\softhsm-2.3.0-x86` directory:

    mkdir C:\build\bin\softhsm-2.3.0-x86
    copy C:\build\src\softhsm-2.3.0-x86\win32\Release\* C:\build\bin\softhsm-2.3.0-x86\

### 64-bit

Extract archive `softhsm-2.3.0.tar.gz` into `C:\build\src\softhsm-2.3.0-x64` directory:

    cd C:\build\src\
    "C:\Program Files\7-Zip\7z" x softhsm-2.3.0.tar.gz
    "C:\Program Files\7-Zip\7z" x softhsm-2.3.0.tar
    rename softhsm-2.3.0 softhsm-2.3.0-x64
    del softhsm-2.3.0.tar

Configure build process in a **new command line window**:

    cd C:\build\src\softhsm-2.3.0-x64\win32\
    "C:\Program Files (x86)\Microsoft Visual Studio 14.0\VC\vcvarsall.bat" amd64
    python Configure.py enable-64bit disable-debug disable-gost with-crypto-backend=openssl with-openssl=C:\build\bin\openssl-1.1.0f-x64\ with-cppunit=C:\build\bin\cppunit-1.13.2-x64\

Open solution `C:\build\src\softhsm-2.3.0-x64\win32\softhsm2.sln` in Visual Studio and rebuild the source with `Release\x64` solution configuration.

Verify the build by running the test programs:

    cd C:\build\src\softhsm-2.3.0-x64\win32\x64\Release\
    cryptotest.exe
    datamgrtest.exe
    handlemgrtest.exe
    objstoretest.exe
...
Copy the results into `C:\build\bin\softhsm-2.3.0-x64` directory:

    mkdir C:\build\bin\softhsm-2.3.0-x64
    copy C:\build\src\softhsm-2.3.0-x64\win32\x64\Release\* C:\build\bin\softhsm-2.3.0-x64\
...
Copy executables to `C:\SoftHSM2\bin\` directory:
    ...
    copy C:\build\bin\softhsm-2.3.0-x86\softhsm2-dump-file.exe C:\SoftHSM2\bin\
    copy C:\build\bin\softhsm-2.3.0-x86\softhsm2-keyconv.exe C:\SoftHSM2\bin\
    copy C:\build\bin\softhsm-2.3.0-x86\softhsm2-util.exe C:\SoftHSM2\bin\
...
Copy configuration file to `C:\SoftHSM2\etc\` directory:
    ...
    copy C:\build\bin\softhsm-2.3.0-x86\softhsm2.conf C:\SoftHSM2\etc\
    copy C:\SoftHSM2\etc\softhsm2.conf C:\SoftHSM2\etc\softhsm2.conf.sample

Copy PKCS#11 libraries to `C:\SoftHSM2\lib\` directory:

    copy C:\build\bin\softhsm-2.3.0-x86\softhsm2.dll C:\SoftHSM2\lib\softhsm2.dll
    copy C:\build\bin\softhsm-2.3.0-x64\softhsm2.dll C:\SoftHSM2\lib\softhsm2-x64.dll
...
Copy manual pages to `C:\SoftHSM2\share\man\` directory:
    ...
    copy C:\build\src\softhsm-2.3.0-x64\src\lib\common\softhsm2.conf.5.in C:\SoftHSM2\share\man\man5\
    copy C:\build\src\softhsm-2.3.0-x64\src\bin\dump\softhsm2-dump-file.1 C:\SoftHSM2\share\man\man1\
    copy C:\build\src\softhsm-2.3.0-x64\src\bin\keyconv\softhsm2-keyconv.1 C:\SoftHSM2\share\man\man1\
    copy C:\build\src\softhsm-2.3.0-x64\src\bin\util\softhsm2-util.1 C:\SoftHSM2\share\man\man1\
...
Update file `C:\SoftHSM2\share\man\man5\softhsm2.conf.txt` with [Windows specific information](https://github.com/disig/SoftHSM2-for-Windows/commit/23c80d9ee9b3fa4e009a9a3786707f81ac7937de).

Convert EOL of `C:\SoftHSM2\etc\softhsm2.conf` and `C:\SoftHSM2\etc\softhsm2.conf.sample` files to Windows format with Notepad++ and update `C:\SoftHSM2\etc\softhsm2.conf` file with [Windows specific information](https://github.com/disig/SoftHSM2-for-Windows/commit/f697543be64c5323ae810121d9d8cb0d4c9a2e42).

Create file [`C:\SoftHSM2\README.txt`](SoftHSM/misc/README.txt).

Create archive `C:\build\SoftHSM2-2.3.0-portable.zip`:

    cd C:\build
    "C:\Program Files\7-Zip\7z" a SoftHSM2-2.3.0-portable.zip C:\SoftHSM2
...
Copy generated MSI installer to `C:\build\` directory:
    ...
    copy C:\build\src\SoftHSM2-for-Windows\WiX\SoftHSM2\bin\Release\SoftHSM2.msi C:\build\SoftHSM2-2.3.0.msi

Sign MSI installer in a **new command line window**:

    "C:\Program Files (x86)\Microsoft Visual Studio 14.0\VC\vcvarsall.bat"
    signtool.exe sign /sha1 84babdf3ba22669463db1ccfa7b1c917462bee4a /fd sha256 /tr http://time.certum.pl/ /td sha256 /d "SoftHSM2" /du "https://www.opendnssec.org/softhsm/" C:\build\SoftHSM2-2.3.0.msi
